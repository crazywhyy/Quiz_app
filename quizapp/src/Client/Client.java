...
public class Client extends javax.swing.JFrame {
    ...
    private int id;
    private boolean flgClose = false;
    private int time;
...
//          System.out.println(temp);
    ...
    public void addCauHoi(int n) {
        if (listQuestion.size() != 0 && listQuestion.size() > n) {
            buttonGroup1.clearSelection();
            Question question = listQuestion.get(n);
            jLabelIdCauHoi.setText(n + 1 + ":");
            jLabelCauHoi.setText(question.getQuestion());
            
            jLabelDapAnA.setText(question.getListAnswer().get(0));
            jLabelDapAnB.setText(question.getListAnswer().get(1));
            jLabelDapAnC.setText(question.getListAnswer().get(2));
            jLabelDapAnD.setText(question.getListAnswer().get(3));
            if (question.getIdAnswer() != null) {
                switch (question.getIdAnswer()) {
                    case "A": {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("BÀI THI TRẮC NGHIỆM");
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                .addComponent(jLabelIdCauHoi, javax.swing.GroupLayout.PREFERRED_SIZE, 20, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        try {
            ...
            if (n == 0) {
                ...
                for (int i = 0; i < n; i++) {
                    ...
                    q.setQuestion(din.readUTF());
                    ArrayList<String> answer = new ArrayList<>();
                    for (int k = 0; k < 4; k++) {
                        answer.add(din.readUTF());
                    }
                    q.setListAnswer(answer);
                    listQuestion.add(q);
                }
                id = 0;
                addCauHoi(0);
        ...
        if (clientSocket != null) {
            try {
                ...
                for (Question Question : listQuestion) {
                    String answer = Question.getIdAnswer();
                    if (answer == null) {
                        dout.writeUTF("");
                    } else {
    ...
    private void jRadioButtonAActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jRadioButtonAActionPerformed
        // TODO add your handling code here:
        Question q = listQuestion.get(id);
        q.setIdAnswer("A");
        listQuestion.set(id, q);
